...
class LastManMap extends JFrame implements GameConstants{
    JFrame thisFrame;
    ...
    public Walls[][] getMap()throws Exception{
        File myFile = new File("Maps/lastman.txt");
    ...
    private class DrawingPanel extends JPanel {
        ...
        public void paintComponent(Graphics g) {
            ...
            Image scapeImg = Toolkit.getDefaultToolkit().getImage("Backgrounds/lastmanBackImg.jpg"); 
